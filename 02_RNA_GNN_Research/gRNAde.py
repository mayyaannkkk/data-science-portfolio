...
CHECKPOINT_PATH = {
    'multi': {
        ...
        4: os.path.join(PROJECT_PATH, "checkpoints/old/SIRD_ARv1_3state_seqid.h5"),
    }
}
...
class gRNAde(object):
    ...
    def design(
        ...
        try:
            ...
            print(f"EternaFold not available, skipping sc_score: {e}")
            sc_score = np.zeros(n_samples)
